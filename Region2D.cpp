...
Region2D Region2D::LoadRegionFromFile(char* filePath)
{
	...
	region.SetBorderWidth(NULL);
	region.SetCenteredRectDims(NULL, NULL);
	region.SetNSides(NULL);
	region.SetRegionCenter(NULL, NULL);
	region.SetRegionColor(NULL);
	//region.SetRegionVerts(NULL);
